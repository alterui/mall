...
public class APP816 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        RequestBody body = RequestBody.create(mediaType, "{\"size\":10000,\"sort\":[{\"@timestamp\":{\"order\":\"desc\",\"unmapped_type\":\"boolean\"}}],\"query\":{\"filtered\":{\"query\":{\"query_string\":{\"query\":\"\\\"send email ATSProcess notice start\\\" AND message:\\\"线上笔试\\\" AND application:\\\"provider-messaging\\\"\",\"analyze_wildcard\":true}},\"filter\":{\"bool\":{\"must\":[{\"range\":{\"@timestamp\":{\"gte\":1597507200000,\"lte\":1597571999999,\"format\":\"epoch_millis\"}}}],\"must_not\":[]}}}},\"highlight\":{\"pre_tags\":[\"@kibana-highlighted-field@\"],\"post_tags\":[\"@/kibana-highlighted-field@\"],\"fields\":{\"*\":{}},\"require_field_match\":false,\"fragment_size\":2147483647},\"aggs\":{\"2\":{\"date_histogram\":{\"field\":\"@timestamp\",\"interval\":\"30m\",\"time_zone\":\"Asia/Shanghai\",\"min_doc_count\":0,\"extended_bounds\":{\"min\":1597507200000,\"max\":1597571999999}}}},\"fields\":[\"*\",\"_source\"],\"script_fields\":{},\"fielddata_fields\":[\"@timestamp\"]}");
        ...
        kits.forEach(e-> {
            String substring = e.get_source().getMessage().substring(35);
            JSONObject jsonObject1 = JSONObject.parseObject(substring);

                }
        );
        System.out.println(kits.size());
        List<Kit> collect = kits.stream().distinct().collect(Collectors.toList());
